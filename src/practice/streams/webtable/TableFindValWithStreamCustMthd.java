...
public class TableFindValWithStreamCustMthd {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		List<WebElement> allVegs=driver.findElements(By.xpath("//td[1]"));		
		
		List<WebElement> filterdVeggie=allVegs.stream().filter(s->s.getText().contains("Rice"))
